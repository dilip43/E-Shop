					...
					{activeTab === 2 && (
						<div className='mt-4'>
							<p className='text-base text-gray-500'>
								...
								delivery. To initiate a return, please email us at support@myecommercestore.com with
								your order number and a brief explanation of why you're returning the item.
							</p>
						</div>
					)}
				</div>
					...
					{activeTab === 4 && (
						<div className='mt-4'>
							<p className='text-base text-gray-500'>
								...
								support@myecommercestore.com, or by calling us at (555) 123-4567 between the hours of
